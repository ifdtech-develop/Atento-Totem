...
import '../../models/oitavo_andar.dart';

class OitavoAndarPage extends StatefulWidget {
  const OitavoAndarPage({Key? key}) : super(key: key);

  @override
  State<OitavoAndarPage> createState() => _OitavoAndarPageState();
}

class _OitavoAndarPageState extends State<OitavoAndarPage> {
                              ...
                              child: Center(
                                child: ListTile(
                                  leading: Container(
                                    ...
                                    child: Icon(
                                      oitavoAndar[index].icon,
                                      color: Colors.white,
                                    ),
                                  ),
                                  title: Text(
                                    oitavoAndar[index].title,
                                    style: TextStyle(
