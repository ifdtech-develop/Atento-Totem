...
import '../../models/quinto_andar.dart';

class QuintoAndarPage extends StatefulWidget {
  const QuintoAndarPage({Key? key}) : super(key: key);

  @override
  State<QuintoAndarPage> createState() => _QuintoAndarPageState();
}

class _QuintoAndarPageState extends State<QuintoAndarPage> {
                              ...
                              child: Center(
                                child: ListTile(
                                  leading: Container(
                                    ...
                                    child: Icon(
                                      quintoAndar[index].icon,
                                      color: Colors.white,
                                    ),
                                  ),
                                  title: Text(
                                    quintoAndar[index].title,
                                    style: TextStyle(
