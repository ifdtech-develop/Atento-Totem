...
import '../../models/setimo_andar.dart';

class SetimoAndarPage extends StatefulWidget {
  const SetimoAndarPage({Key? key}) : super(key: key);

  @override
  State<SetimoAndarPage> createState() => _SetimoAndarPageState();
}

class _SetimoAndarPageState extends State<SetimoAndarPage> {
                              ...
                              child: Center(
                                child: ListTile(
                                  leading: Container(
                                    ...
                                    child: Icon(
                                      setimoAndar[index].icon,
                                      color: Colors.white,
                                    ),
                                  ),
                                  title: Text(
                                    setimoAndar[index].title,
                                    style: TextStyle(
